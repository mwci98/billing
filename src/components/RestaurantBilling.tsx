...
export const RestaurantBilling: React.FC = () => {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-5 md:grid-cols-[minmax(0,1fr)_300px] lg:grid-cols-[minmax(0,1fr)_360px] xl:grid-cols-[minmax(0,1fr)_390px]">
        ...
        <aside className="md:sticky md:top-20 md:self-start"><div className="overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-xl dark:border-white/10 dark:bg-[#141416]">
